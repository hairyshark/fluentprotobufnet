    ...
    public class TestBasicMapping
    {
        ...
        public void TestRoundTripBaseType()
        {
            var obj = new Category()
            {
                Name = "Foo",
                ParentCategory =
                    new CategoryWithDescription() { Name = "Bar", Description = "ScoobyDoo", ParentCategory = new CategoryWithDescription { Name = "Foo" } },
                Items = new[]
                            {
        ...
        [Test]
        public void TestRoundTripWithCircularReference()
        {
            var categoryWithDescription = new CategoryWithDescription
                                              {
                                                  Name = "Bar",
                                                  Description = "ScoobyDoo",
                                                  ParentCategory = new CategoryWithDescription { Name = "Wibble" }
                                              };
                                          ...
                                          new Item
                                              {
                                                  Definition = "abc",
                                                  MainCategory =
                                                      new CategoryThirdLevel { Description = "bananas" }
                                              },
                                          new Item
                                              {
                                                  Definition = "def",
                                                  MainCategory =
                                                      new CategoryThirdLevel { Description = "apples" }
                                              },
                                          new Item
                                              {
                                                  Definition = "ghi",
                                                  MainCategory =
                                                      new CategoryThirdLevel { Description = "oranges" }
                                              }
                                      },
                              ParentCategory = categoryWithDescription
                          };

            categoryWithDescription.ParentCategory = obj;
