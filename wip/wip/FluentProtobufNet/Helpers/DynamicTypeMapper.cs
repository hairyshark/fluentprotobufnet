...
namespace FluentProtobufNet.Helpers
{
    ...
    public static class DynamicTypeMapper
    {
        public static void BuildUp<TMapper, TMessage, TReferenceSpecification>(this TMapper mapper, Func<PropertyInfo, int> indexor, Func<PropertyInfo, bool> selector = null) 
            ...
            where TReferenceSpecification : ISpecification<Type>, new()
        {
        ...
        private static Tuple<Expression<Func<TMessage, object>>, bool, int> Build<TMessage>(PropertyInfo targetMember, Func<PropertyInfo, int> indexor, ISpecification<Type> referenceSpecification)
        {
            ...
            var isReference = referenceSpecification.IsSatisfied(targetMember.PropertyType);
